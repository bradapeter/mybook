...
当前「一块地」的核心产品服务是一种会员资格，用户成为会员，需加入（开通）这种合约服务计划（Service Contract Plan，简称SCP）
...
其中基础包、附加包、其它（鸡、蛋、茶）等可独立出来单独销售。现阶段种植服务涵盖这些内容不单独销售。这种会员服务可以有多种，根据客户的消费能力和家庭规模大小区分在于土地的面积大小和可种蔬菜品类的限制，另外就是附加包中配送的品种和数量。
